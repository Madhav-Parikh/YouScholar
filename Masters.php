...
<div class="alert-content"><p>We have listed below some of the best available scholarships in the Masters level. You can study in Masters on fully funded or partially funded scholarships. Take a look and choose the scholarship which suits you the best. If you have any queries regarding the scholarships, you can always post them in the Expert Help.</p></div>
</div>
<?php
                $query = "SELECT * FROM scholarships where scholarship_degree='Masters'  ORDER BY scholarship_id DESC";
...
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="MD_IELTS.php">IELTS Test Fee Scholarship</a></h2>
<ul><li>
<i class="icon-map"></i> All States </li>	

<li><i class="icon-dollor"></i> Full Funding </li>

<li>
<i class="icon-Bachelor2"></i> Masters </li>

<li>
<i class="icon-place"></i> Have more than 3.0 GPA </li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
<a href="MD_IELTS.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
<p>IELTS Test Fee Scholarship, 2021 is offered for Bachelors, Masters degree in the field of English. You can apply to this scholarship here. The deadline for the sending your application is 30 Mar 2021. This scholarship is provided by IELTS Dates and the value of this scholarship is Full Funding, Covers full fee payment of an IELTS exam . This scholarship is open for: Open to all nationals.</p>
</div>
</div>
...
<img src="https://www.scholarships.net.in/uploads/images2021/46992-1.jpg" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class="card-deal-title"></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="MD_BISPT.php">Berows International Scholarship Program Test (BISPT)</a></h2>
<ul><li>
<i class="icon-map"></i> All States </li>	
...
<div class="card-more">
<a href="MD_BISPT.php
"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
