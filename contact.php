...
<?php
    ...
    $Name    = "";
    $to      = "186330307027.harsh.joshi@gmail.com";
    $SNAme   = "";
    $SDetail = "";
    $headers = 'From: scholarshipsads.com';
    if(mail($Name, $to, $SNAme,$SDetail, $headers)){
      echo "email sent";
    }else{
      echo "email not sent";
    }
