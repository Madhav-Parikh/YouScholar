...
<h1>Yashad-Sumedha Scholarship Programme</h1>
</div>
...
<p>Yashad-Sumedha and Hindustan Zinc Limited, Udaipur&nbsp;invite applications from students studying in the first semester of B.Tech in the academic year 2019-20 for Yashad-Sumedha Scholarship Programme 2020. The selected candidates&nbsp;will receive a scholarship of INR 20,000 per annum.&nbsp;</p>
</div>
<div class="scholarship-item">
<h3>Eligibility</h3>
...
<ul>
  <li>Be studying in the first semester of B.Tech in any government college</li>
  <li>Be a permanent resident of any of these 5 districts: Udaipur, Rajsamand, Bhilwara, Ajmer, Chittorgarh</li>
  <li>Have obtained a minimum of 75% marks in the senior secondary examination</li>
  <li>Have an annual family income of less than INR 2.5 Lakhs</li>
</ul>

<p><em><strong>Note</strong>: Preference&nbsp;would be given to students belonging to BPL families, orphans, single parent-child and girls</em></p></div>
</div>
<div class="scholarship-item">
<h3>Benefits</h3>
<p>Selected students will receive a scholarship of INR 20,000 per annum.</p></div>
<div class="scholarship-item">
<h3>Documents</h3>
<div><ul>
  <li>A self-attested copy of 10th mark sheet</li>
  <li>A self-attested copy of 12th mark sheet</li>
  <li>Photos of the applicant (5)</li>
  <li>A copy of Pension's Payment Order (P.P.O.) (if applicable)</li>
  <li>Income certificate</li>
  <li>Death certificate, if applicable</li>
  <li>A copy of BPL card, if applicable</li>
  <li>A copy of ration card</li>
  <li>A copy of the cover of bank passbook</li>
  <li>A copy of fee receipt</li>
</ul></div></div>
<div class="scholarship-item">
<h3>How can you apply?</h3>
<div><p>Eligible candidates can apply for the scholarship online by&nbsp;following the steps below -<br>
<strong>Step 1:</strong>&nbsp;Click on the '<strong>View scholarship </strong>' button below.<br>
<strong>Step 2</strong>: Read the instruction carefully before applying, then click on 'Next' to proceed.<br>
<strong>Step 3</strong>: Sign up to register as a new user.<br>
<strong>Step 4</strong>: Now, sign in using the login ID and password.<br>
<strong>Step 5</strong>: Click on 'Fresh Apply' to open the application form.<br>
<strong>Step 6</strong>: Fill the application form and save the details.<br>
<strong>Step 7</strong>: Now, download the PDF&nbsp;format of the completed application and send it along with required documents at the address mentioned below:<br>
<strong>Sumedha,&nbsp;<br>
5 Keshav Vihar,&nbsp;<br>
Gopalpura Bypass Road,&nbsp;<br>
Jaipur- 302018</strong><br>
<strong>Note:</strong> <em>The form has to be sent by the&nbsp;Head of the Institution where the student is studying after attestation.</em></p></div></div><!--
<div class="scholarship-item">
...
<a class="btn" href="http://www.sumedha.org/yashad-sumedhascholarship/index.php">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
