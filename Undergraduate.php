...
<h3>Scholarships in Undergraduate</h3>
</div>
...
<div class="alert-content"><p>We have listed below some of the best available scholarships in the Undergraduate level. You can study in Undergraduate on fully funded or partially funded scholarships. Take a look and choose the scholarship which suits you the best. If you have any queries regarding the scholarships, you can always post them in the Expert Help.</p></div>
</div>
<?php
                $query = "SELECT * FROM scholarships where scholarship_degree='Undergraduate'  ORDER BY scholarship_id DESC";
...
<img src="https://www.webexam.in/wp-content/uploads/2019/06/GP-Birla-Scholarship.jpg" alt=""><div class="">
...
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="UG_GPB.php">G. P. Birla Scholarship</a></h2>
<ul><li>
<i class="icon-dollor"></i> All Streams </li>
<li>
<i class="icon-place"></i> West Bengal </li>
...
<li>
<i class="icon-map"></i> More the 80% in Class 12 </li>
<!-- <li> |
...
<div class="clearfix"></div>
<div class="card-more">
<a href="UG_GPB.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
<p>G. P. Birla Educational Foundation is offering G. P. Birla Scholarship 2020 to meritorious students from West Bengal, who have passed Class 12 examination in 2020. The selected candidate will receive a scholarship worth INR 50,000 per year and other benefits. The scholarship can be availed by students pursuing courses in any stream including Science, Commerce, Arts, Engineering, Medicine, Architecture etc.</p>
</div>
</div>
...
<img src="https://4.bp.blogspot.com/-9hzp_1I2k80/XGvv2L4eIlI/AAAAAAAAAYE/8hM6p8uTnpgxL2oj5Cu5WqYrkNXjLbnZwCK4BGAYYCw/w1200-h630-p-k-no-nu/App-Banner-CLP.png" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class="card-deal-title"></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="UG_CLP.php">CLP India Scholarship Scheme</a></h2>
<ul><li>
          <i class="icon-map"></i>Madhya Pradesh</li>	
          
          <li><i class="icon-dollor"></i>Up to ₹ 18,000</li>
