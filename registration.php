...
?>
    <form class="form" action="" method="post">
        <h1 class="login-title"><b>Registration</h1><b>
        ...
        <input type="text" class="login-input" name="number" placeholder="Mobile Number"  required />
        <input type="submit" name="submit" value="Register" class="login-button"  required />
        <p class="link">Already have any account? <a href="login.php">Login here</a></p>
    </form>
<?php
    }
?>
