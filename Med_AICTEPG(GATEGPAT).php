...
<p>All India Council for Technical Education (AICTE) invites applications from GATE/GPAT qualified students for AICTE PG (GATE/GPAT) Scholarship 2020-21. The key objective of the scholarship is to ensure the development of technical education in India. Eligible scholars will get a monthly stipend of INR 12,400 for their post-graduate studies.&nbsp;</p>
</div>
<div class="scholarship-item">
<h3>Eligibility</h3>
...
<ul>
  <li>Have obtained a valid score&nbsp;in GATE/GPAT examination.</li>
  <li>Have taken admission in the 1st year of M.Tech./M.E./M.Pharma/M.Arch. courses at an AICTE recognized institution in the academic year 2020-21.&nbsp;</li>
</ul></div>

</div>
<div class="scholarship-item">
<h3>Benefits</h3>
<div><p>The selected students will get a monthly stipend of INR 12,400 per month for the duration of two years or the duration of the course, whichever is lower.</p></div>
</div>
<div class="scholarship-item">
<h3>Documents</h3>
<div><p>The following documents are required:</p>

<ul>
  <li>GATE/GPAT scorecard (Scanned)</li>
  <li>Bank passbook (Scanned)</li>
  <li>Scanned copy of Aadhaar card&nbsp;(Students from J&amp;K, Meghalaya and Assam are exempted)&nbsp;</li>
  <li>Scanned copy of caste certificate</li>
  <li>Scanned copy of the Non-Creamy Layer (NCL) certificate,&nbsp;not more than a year old (only for OBC candidates)</li>
</ul>

<p><strong>Note</strong>: All the documents uploaded must be in PDF format.</p></div>
</div>
<div class="scholarship-item">
<h3>How can you apply?</h3>
<div><p>Eligible candidates can apply for the scholarship online through following steps -</p>

<p><strong>Step 1</strong>: Get the institute ID and student ID from the institute.<br>
<strong>Step 2</strong>: Click on the 'Apply Now' button below and&nbsp;provide the necessary details to validate student ID.&nbsp;<br>
<strong>Step 3</strong>: Fill in the application form for PG Scholarship GATE/GPAT.&nbsp;<br>
<strong>Step 4</strong>: Upload the required documents to the portal in PDF format only.&nbsp;<br>
<strong>Step 5</strong>: Click on "Submit Application" after completing all the steps.&nbsp;</p></div>
</div><!--
<div class="scholarship-item">
...
<a class="btn" href="https://www.aicte-india.org/schemes/students-development-schemes/PG-Scholarship-Scheme/General-instruction">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
