...
<h1>IELTS Test Fee Scholarship</h1>
</div>
...
<p>The British Council invites applications from IELTS test takers&nbsp;for British Council IELTS Prize 2020. Under this programme, ten lucky IELTS test-takers will be given a GBP 3,000 prize toward their study fees in Autumn/Winter 2020 and Early 2021. This prize is open for test-takers living in countries like India, Nigeria, UAE, Uzbekistan, Pakistan, and Colombia.&nbsp;</p>
</div>
<div class="scholarship-item">
<h3>Eligibility</h3>
...
<ul>
  <li>Be 18 years of age or above</li>
  <li>Live in the country he/she is applying from</li>
  <li>Have taken IELTS with British Council between January 2019 and February 2020</li>
  <li>Have an overall IELTS score of 5 or above</li>
  <li>Be applying for a first-year undergraduate or postgraduate degree in Fall 2020/Spring 2021</li>
  <li>Be applying to an institution that requires an IELTS score as part of its application process.&nbsp;</li>
</ul></div>
</div>
<div class="scholarship-item">
<h3>Benefits</h3>
<div><p>Ten IELTS test-takers will get GBP 3,000 towards their study fees.</p></div>
</div>
<div class="scholarship-item">
<h3>Documents</h3>
<div><ul>
  ...
  <li>Passport or identification document to prove permanent residency</li>
  <li>Special requirements certificate (if applicable)</li>
  <li>Personal statement of not more than 500 words</li>
</ul></div>
</div>
<div class="scholarship-item">
<h3>How can you apply?</h3>
<div><p>Follow the steps given below to apply -<br>
<strong>Step 1</strong>: Visit the <a href="https://ieltsprize.takeielts.britishcouncil.org/application/" rel="nofollow" target="_blank">official application page</a>.&nbsp;<br>
<strong>Step 2</strong>: Click on '<a href="https://ieltsprize.takeielts.britishcouncil.org/sign-up/" rel="nofollow" target="_blank">Sign up now</a>' to start the application.<br>
<strong>Step 3</strong>: Provide the necessary details and sign up.&nbsp;<br>
<strong>Step 4</strong>: Read the instructions carefully and click on 'Apply Now' button.<br>
<strong>Step 5</strong>: Fill in all required details.<br>
<strong>Step 6</strong>: Upload the required documents and submit the application.&nbsp;</p></div>
</div><!--
<div class="scholarship-item">
...
<a class="btn" href="https://ieltsprize.takeielts.britishcouncil.org/application/">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
