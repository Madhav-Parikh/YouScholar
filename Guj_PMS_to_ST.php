...
<h1>
Post Matric Scholarship for ST Students</h1>
</div>
...
<h3>Eligibility</h3>
<div><ul>
	<li>An applicant must belong to ST category.</li>
	<li>Applicant must be studying in graduation to postgraduation from a recognized&nbsp;college, university or institute.&nbsp;&nbsp;</li>
	<li>The annual family income (from all sources)&nbsp;must be less than INR 2,50,000.</li>
	<li>The student should not be a repeater in the same class for more than once.</li>
	<li>The student should be a&nbsp;permanent resident of Gujarat state.</li>
	<li>Students who pursue their studies through correspondence courses are also eligible. The term correspondence includes distance and continuing education.</li>
</ul></div></div>
<div class="scholarship-item">
<h3>Benefits</h3>
<p>The award amount may vary according to the class in which the applicant is studying.<br></p> </div>
<div class="scholarship-item">
<h3>Documents</h3>
<div><ul>
	<li>Passport size photograph of the applicant</li>
	<li>Self-attested caste certificate issued by the competent authorities</li>
	<li>Self-attested copy of the Aadhaar Card</li>
	<li>The first page of bank passbook/cancelled cheque</li>
	<li>Self-attested certificate of previous academic mark sheet</li>
	<li>Disability certificate (applicable for persons with disability)</li>
	<li>Fee receipt of current academic course year</li>
	<li>Break affidavit (If break gap is more than one year)</li>
	<li>Income certificate issued by a competent authority (Form no.16 required for Govt. Employee)</li>
	<li>Thesis typing/printing bill (applicable for MPhil, PhD, D.Litt, D.Pharm, D.Sc students)</li>
	<li>School leaving certificate</li>
	<li>Domicile certificate (for Gujarati origin ST student studying in outstate)</li>
	<li>Hostel Certificate (applicable for hosteler students)</li>
	<li>LWP (Leave without pay) certificate (for employed students)</li>
</ul></div></div>
<div class="scholarship-item">
...
<strong>Step 2</strong>: Fill in the details and register.&nbsp;<br>
<strong>Step 3</strong>: After successful registration, login with username and password.&nbsp;<br>
<strong>Step 4</strong>: Fill in the scholarship application form and upload the required documents.&nbsp;<br>
<strong>Step 5:&nbsp;</strong>Finally submit the application form.&nbsp;</p></div></div><!--
<div class="scholarship-item">
...
<a class="btn" href="https://scholarships.gov.in/public/schemeGuidelines/PostMatricUmbrella_tripura.pdf" target="_blank">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
