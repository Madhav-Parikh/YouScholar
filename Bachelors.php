...
<li class="breadcrumb-item active" aria-current="page">Bachelors</li>
</ol><div class="title-heading">
<h3>Scholarships in Bachelors</h3>
</div>
...
<div class="alert-content"><p>We have listed below some of the best available scholarships in the Bachelors level. You can study in Bachelors on fully funded or partially funded scholarships. Take a look and choose the scholarship which suits you the best. If you have any queries regarding the scholarships, you can always post them in the Expert Help.</p></div>
</div>
<?php
                $query = "SELECT * FROM scholarships where scholarship_degree='Bachelors'  ORDER BY scholarship_id DESC";
...
<img src="https://ieltsdates.com/wp-content/uploads/2020/03/IELTS-Test-Fee-Scholarship-2020-Call-for-Applications-1280x720.png" alt=""><div class="">
...
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="BC_SI.php">Schaeffler India Hope Engineering Scholarship</a></h2>
<ul>
...
<div class="clearfix"></div>
<div class="card-more">
<a href="BC_SI.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
...
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="BC_BISPT.php">Berows International Scholarship Program Test (BISPT)</a></h2>
<ul><li>
...
<div class="clearfix"></div>
<div class="card-more">
<a href="BC_BISPT.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
<p>Berows International Scholarship Program Test (BISPT) 2021 is offered for High/Secondary School, Bachelors, Masters degree in the field of All courses. You can apply to this scholarship here. The deadline for the sending your application is 31 Mar 2021. This scholarship is provided by Berows International Scholarship Program Test (BISPT) and the value of this scholarship is Full Funding, $16,000 USD . This scholarship is open for: Open to all nationals.</p>
</div>
</div>
