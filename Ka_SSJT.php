...
<h1>
Dr. Shamanur Shivashankarappa Janakalyana Trust's Scholarship Program</h1>
</div>
...
<p>Dr Shamanur Shivashankarappa Janakalyana Trust's Scholarship Program 2020 invites applications from students of Class 11 to post-graduation who are willing to pursue their higher education in the professional courses like Engineering, Technology, Management, Law, Nursing, Medicine and Dental Sciences. The main aim is to&nbsp;assist intelligent but economically poor students of Karnataka.</p>
</div>
<div class="scholarship-item">
<h3>Eligibility</h3>
...
<ul>
  <li>Have&nbsp;domicile&nbsp;of Karnataka state</li>
  <li>Have an annual family income not more than INR 1 lakh&nbsp;from all sources</li>
  <li>Have taken admission to the regular courses at reputed colleges</li>
</ul></div>
</div>
<div class="scholarship-item">
<h3>Benefits</h3>
<p>Financial support will be granted&nbsp;to meritorious and needy students until the completion of the course.</p></div>
<div class="scholarship-item">
<h3>Documents</h3>
<div><p>Following documents are required at the time of the application:</p>

<ul>
  <li>Passport size photo should be attached to the printed application form.</li>
  <li>Class 10&nbsp;and Class 12&nbsp;mark&nbsp;sheet.</li>
  <li>Latest year or semesters marks sheet&nbsp;if studying in graduation or postgraduation.</li>
  <li>Income certificate should not be more than INR 1 lakh from all the sources.</li>
  <li>Copy of Admission receipt/fee receipt.</li>
  <li>Copy of Identity card (if issued by the Institution).</li>
  <li>Copy of Student Bank account passbook.</li>
  <li>Copy of AADHAAR card.</li>
</ul></div>
</div>
<div class="scholarship-item">
<h3>How can you apply?</h3>
<div><p>Interested candidate can apply online by following these&nbsp;steps:</p>

<p><strong>Step 1:</strong>&nbsp;Click on the '<strong>>View scholarship</strong>' button.<br>
<strong>Step 2:</strong>&nbsp;Completely fill the form<br>
<strong>Step 3:</strong> Make sure that the mandatory fields&nbsp;are completely filled such as personal details, educational details, aadhaar&nbsp;number and bank account details.<br>
<strong>Step 4:&nbsp;</strong>Click to declare and submit.<br>
<strong>Step 5:</strong>&nbsp;Send a print out of the application form along with the required documents&nbsp;by courier, post or personally to:</p>

<p>The Secretary</p>

<p>Dr Shamanur Shivashankarappa Janakalyan Trust<br>
C/o. R L Law College,<br>
Behind Bapuji Educational Association Head office,<br>
P J Extension, Davangere-577002,<br>
...
<a class="btn" href="https://ssjanakalyantrust.org/online-application.php">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
