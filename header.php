<header id="header" class="header header-1 header-transparent header-fixed"><nav id="primary-menu" class="navbar navbar-expand-lg navbar-light"><div class="container">
...
<!--
---------------DROPDOWN DIRRECTION WISE NORTH ,SOUTH,EAST ,WEST------------------------------
<li class="has-dropdown"> 
<a href="#" data-toggle="dropdown" class="dropdown-toggle menu-ites</a>
<ul class="dropdown-menu"><li>
<a href="asian-countries.php">Northen States</a>
</li>
<li>
<a href="african-countries.php">Eastern States</a>
</li>
<li>
<a href="european-countries.php">Western States</a>
</li>
<li>
<a href="oceania-countries.php">Southern States</a>
</li>
</ul></li>-->
<li class="has-dropdown">
