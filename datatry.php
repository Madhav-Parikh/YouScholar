...
<li class="breadcrumb-item active" aria-current="page">Gujarat</li>
...
<?php
                $query = "SELECT * FROM scholarships where scholarship_state='Gujarat' ORDER BY scholarship_id DESC";
...
<a href=trial.php?sid=<?php  echo $row['scholarship_id']; ?>><?php  echo $row['scholarship_title']; ?></a></h2>
<ul>
