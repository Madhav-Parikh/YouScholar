...
<h1>Fullerton India Scholarship Programme</h1>
</div>
...
<p><strong>Fullerton India Scholarship Programme</strong> is a CSR initiative of <strong>Fullerton India</strong> to financially support school students who face financial barriers in pursuing their education. The scholarship programme aims at helping underprivileged students of Class 9-12 from Madhya Pradesh (Vidisha and Khandwa), Rajasthan (Hanumangarh and Sri Ganganagar) and West Bengal (Jalpaiguri and Haldia).&nbsp;</p>
<p>With financial inclusion at the core of its guiding business vision, <strong>Fullerton India</strong> has been serving the under-banked and unbanked population with its financial services. &nbsp;As part of its Corporate Social Responsibility, the organisation has also been running several education programmes aimed at upgradation of skills among individuals and community empowerment.&nbsp;</p>
</div>
<div class="scholarship-item">
<h3>Eligibility</h3>
<div><ul>
  <li>Open for students studying in Class 9-12&nbsp;</li>
  <li>Applicants must have scored at least 60% marks in the previous class &nbsp;</li>
  <li>Annual family income of the applicant must be less than or equal to INR 4,00,000 (4 lakh)&nbsp;</li>
  <li>Open only for the students from the following districts -
  <ul>
    <li>Vidisha and Khandwa (Madhya Pradesh)</li>
    <li>Hanumangarh and Sri Ganganagar (Rajasthan)</li>
    <li>Jalpaiguri and Haldia (West Bengal)</li>
  </ul>
  </li>
</ul></div></div>
<div class="scholarship-item">
...
<div><p>The following documents are required to be uploaded at the time of application:</p>

<ul>
  <li>Photo identity proof</li>
  <li>Address proof</li>
  <li>Income proof (Form 16A/income certificate from government authority/salary slips, etc.)&nbsp;</li>
  <li>Proof of admission (School ID card/Admission Receipt etc.)</li>
  <li>Current academic year fee receipt</li>
...
<div><ul>
  <li>You will now be redirected to the Fullerton India Scholarship Programme detail page&nbsp;</li>
  <li>Click on the ‘Apply Now’ button to begin the application process.&nbsp;</li>
  <li>Fill the required details in the online application form&nbsp;</li>
  <li>Upload the necessary documents as part of the application process&nbsp;</li>
...
<a class="btn" href="https://www.fullertonindia.com/csr/education.aspx">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
