...
<?php
$sid=$_GET['sid'];
                $query = "SELECT * FROM scholarships where scholarship_id=$sid";
...
<h1><?php  echo $row['scholarship_title']; ?></h1>
</div>
...
<div class="scholarship-item">
<h3>Eligibility:</h3>
<div><p><?php  echo $row['scholarship_eligibility_desc']; ?></p>
...
<div class="scholarship-item">
<h3>Benefits:</h3>
<p><?php  echo $row['scholarship_benefits_desc']; ?></p></div>
<div class="scholarship-item">
<h3>Documents:</h3>
<div><?php  echo $row['scholarship_documents_desc']; ?>
</div></div>
<div class="scholarship-item">
<h3>How can you apply?</h3>
<div><p><?php  echo $row['scholarship_process_desc']; ?></p></div></div>
...
<a class="btn" href=<?php  echo $row['scholarship_url']; ?>>View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
