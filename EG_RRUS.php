...
<h1>Rolls-Royce Unnati Scholarships for Women Engineering Students</h1>
</div>
...
<p><strong>‘Rolls-Royce Unnati Scholarships for Women Engineering Students’</strong> is an initiative of <strong>Rolls-Royce India Pvt.&nbsp;Ltd.</strong> to financially support meritorious girl students in completing their engineering programme. The scholarship is aimed at helping girl students studying in the 1st/2nd/3rd year of undergraduate engineering degree programme at an AICTE recognized institution in India.</p>
<p>This scholarship is being offered by Rolls-Royce India&nbsp;as part of its Corporate Social Responsibility (CSR) initiatives that primarily focus on supporting and encouraging students interested in&nbsp;Science, Technology, Engineering and Mathematics (STEM) subjects. The company also runs several projects to promote STEM learning programmes and skill development.</p>
</div>
<div class="scholarship-item">
<h3>Eligibility</h3>
<div><ul>
  <li>Open for girl students only.</li>
  <li>Applicants must be studying in 1st/2nd/3rd year of Engineering degree programme (in fields like Aerospace, Marine, Electronics, Computers, etc.) at an AICTE recognized institution.</li>
  <li>Applicants must have scored more than 60% marks in their Class 10 and 12 board exams.</li>
</ul></div>
</div>
<div class="scholarship-item">
<h3>Benefits</h3>
<div><p>INR 35,000</p></div>
</div>
<div class="scholarship-item">
<h3>Documents</h3>
<<div><ul>
  ...
  <li>Address proof</li>
  <li>Class 10 or Class 12 marksheet (self-attested copy)</li>
  <li>Proof of admission (college ID card/admission fees receipt etc.)</li>
  <li>Current academic year fee receipt&nbsp;</li>
  <li>Bank account details of the scholarship applicant (cancelled cheque/passbook copy)</li>
</ul></div>
</div>
<div class="scholarship-item">
<h3>How can you apply?</h3>
<div><ul>
  <li>Click on the ‘View scholarship ’ button below.</li>
  <li>You will now be redirected to the ‘Rolls-Royce Unnati Scholarships for Women Engineering Students’ application form page.</li>
...
<a class="btn" href="https://uqidar.org/apply/?gclid=Cj0KCQjwl9GCBhDvARIsAFunhslHs01GgZql3AG6eE6UOi2CtpK567qjMufv-dO242q67yYbN66kL-4aApHfEALw_wcB&gclsrc=aw.ds">View scholarship <i class="fa fa-external-link"></i></a>
</div>
</div>
