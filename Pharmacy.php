...
<h3>Scholarships in Pharmacy</h3>
</div>
...
<div class="alert-content"><p>Are you looking for scholarships in the field of Pharmacy? We have listed some of the best available scholarships for you down below. Choose your preferred scholarship based on the englibility and your requirements.</p></div>
</div>

<?php
                $query = "SELECT * FROM scholarships where scholarship_course='Pharmacy'  ORDER BY scholarship_id DESC";
...
<img src="https://s3-ap-southeast-1.amazonaws.com/buddy4study/blog/uploads/2018/09/06103257/Merit-scholarships.png" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class=""></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="deutschlandstipendium-scholarship-germany.php">Merit Scholarship for Bachelors Program</a></h2>
<ul><li>
...
<li>
<i class="icon-book"></i> Pharmacy </li>

<li>
<i class="icon-Bachelor2"></i> Bachelors </li>

<li>
<i class="icon-place"></i> 75% marks in their last appeared examination </li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
<a href="deutschlandstipendium-scholarship-germany.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
<p>Merit Scholarship for Bachelors Program, 2021 is offered for Bachelors degree in the field of Courses of Pharmacy. We look to provide great opportunities for the students interested to pursue Pharmacy. You can apply to this scholarship here. </p>
</div>
</div>
<div class="scholarship-card">
<div class="card-warp">
...
<img src="https://www.wemakescholars.com/admin/uploads/providers/-O8x_rV0QQn-TSdh5cTTbkha7hy36eFn.png" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class=""></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="friedrich-naumann-foundation-scholarship.php">Sitaram Jindal Scholarship for Students of Pharmacy</a></h2>
<ul><li>
<i class="icon-map"></i> All States </li>	

<li><i class="icon-dollor"></i> Up to INR 2500 per month </li>

<li>
<i class="icon-book"></i> Pharmacy </li>

<li>
<i class="icon-Bachelor2"></i> Degree/Masters </li>

<li>
<i class="icon-place"></i>Studying in class 11 to post-graduation</li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
...
<div class="card-bio">
<p>IT Zero Fees English Scholarship is offered for Bachelors, Diploma degree in the field of Courses in the field of Courses of Pharmacy. We look to provide great opportunities for the students interested to pursue Pharmacy. You can apply to this scholarship here.</p>
</div>
</div>
...
<li>
<i class="icon-Bachelor2"></i> Bachelors, Postgraduate </li>
<li>
<i class="icon-book"></i> All Subjects </li>
<li>
...
<div class="card-bio">
<p> DAAD: Re-invitation Programme for Former Scholarship Holders is open for students intrested in Bachelors, Postgraduate scholarships in Germany.</p>
</div>
</div>
<div class="scholarship-card">
<div class="card-warp">
...
<div class="card-body">
<h5 class="card-title"><a href="concordia-university-Bachelors-graduate-entrance-scholarships.php">Concordia University - Bachelors Graduate Entrance Scholarships</a></h5>
<div class="card-meta">
<span class="card-date">14 Aug 2020</span>
<span class="card-more"><a href="concordia-university-Bachelors-graduate-entrance-scholarships.php"><i class="icon-arrow-long-right"></i></a></span>
</div>
</div>
</div>
</div>
