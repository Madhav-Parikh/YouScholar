...
<li class="breadcrumb-item active" aria-current="page">Karnataka</li>
</ol><div class="title-heading">
<h3>Scholarships in Karnataka</h3>
</div>
...
<div class="alert-content"><p>You can study in Karnataka on fully funded or partially funded scholarships. Government of Karnataka and Universities in Karnataka offer scholarships. We have listed here some best PhD Scholarships in Karnataka, Masters Scholarships in Karnataka, and undergraduate level scholarships.</p></div>
</div>
<?php
                $query = "SELECT * FROM scholarships where scholarship_state='Karnataka' ORDER BY scholarship_id DESC";
...
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="deutschlandstipendium-scholarship-germany.php">Merck India Charitable Trust Scholarship Program</a></h2>
<ul><li>
<i class="icon-map"></i> Karnataka, Navi Mumbai, Thane </li>	
...
<li>
<i class="icon-place"></i> Class 10 (SSC) with minimum 80% marks </li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
...
<div class="card-bio">
<p>Merck India Charitable Trust (MICT) Scholarship Program is an initiative of Merck India that aims to support under-privileged students who are keen to pursue higher education. The scholarship program is open for students residing and studying in Mumbai, Navi Mumbai, Thane and Bengaluru. It offers financial assistance to Class 10 passed students until they graduate in a chosen discipline. Under this scholarship program, MICT scholars will receive INR 35,000 per year (based on actual receipts of education expenses as submitted by students) to cover their various academic expenses. The long-term financial support offered by this scholarship is aimed at encouraging talented students from financially weaker families and help them in laying a foundation for a bright and secure future.</p>
</div>
</div>
<div class="scholarship-card">
<div class="card-warp">
...
<img src="https://i2.wp.com/www.indcareer.com/scholarships/wp-content/uploads/2019/11/images-25.jpeg?fit=263%2C141&ssl=1" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class=""></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="friedrich-naumann-foundation-scholarship.php">National Overseas Scholarship for Minority Community Students, Karnataka</a></h2>
<ul><li>
<i class="icon-map"></i> Karnataka </li>	
...
<li>
<i class="icon-place"></i> Must be in Minority Community</li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
...
<div class="card-bio">
<p>The students of the Minority community (Muslims, Christians, Jains, Buddhists, Sikhs and Parsis) can apply for the scholarship.
The scholarship is applicable for Master’s, PhD, and Postdoctoral degrees.</p>
</div>
</div>
