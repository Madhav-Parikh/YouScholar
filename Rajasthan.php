...
<h3>Scholarships in Rajasthan</h3>
</div>
...
<div class="alert-content"><p>You can study in Rajasthan on fully funded or partially funded scholarships. Government of Rajasthan and Universities in Rajasthan offer scholarships. We have listed here some best PhD Scholarships in Rajasthan, Masters Scholarships in Rajasthan, and undergraduate level scholarships.</p></div>
</div>
...
<?php
                $query = "SELECT * FROM scholarships where scholarship_state='Rajasthan' ORDER BY scholarship_id DESC";
...
<img src="https://s3-ap-southeast-1.amazonaws.com/cdn.buddy4study.com/static/scholarship_logo/logo_16928_1566884977.png" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class="card-deal-title"></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="Rj_YSP.php">Yashad-Sumedha Scholarship Programme</a></h2>
<ul><li>
<i class="icon-map"></i> Rajasthan </li>	

<li><i class="icon-dollor"></i> Selected students will receive a scholarship of INR 20,000 per annum </li>
...
<li>
<i class="icon-place"></i> Minimum of 75% marks in the senior secondary examination </li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
<a href="Rj_YSP.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
...
<img src="https://www.91sarkariyojana.in/wp-content/uploads/2020/08/Mukhyamantri-Uch-Siksha-Chatravriti-Yojana-Rajasthan.jpg" alt=""><div class="">
<span class=""><i class=""></i></span>
<span class="card-deal-title"></span>
</div>
</div>
<div class="card-info col-xs-12 col-md-8 col-lg-8">
<h2><a href="Rj_MMUSY.php">Mukhya Mantri Uchh Shiksha Yojana, Rajasthan</a></h2>
<ul><li>
<i class="icon-map"></i> Rajasthan </li>	

<li><i class="icon-dollor"></i> Up to INR 5000 per year </li>

<li>
<i class="icon-book"></i> Any Stream </li>

<li>
<i class="icon-Bachelor2"></i> Graduate/ITI/Polytechnic Diploma </li>

<li>
<i class="icon-place"></i> Have passed Class 12 Examinations </li>
</ul></div>
</div>
<div class="clearfix"></div>
<div class="card-more">
<a href="Rj_MMUSY.php"><span>Learn More</span><i class="icon-arrow-long-right"></i></a>
</div>
<div class="card-bio">
